		...
		do {
			...
			if(benchmark == 1) {
				if(algorithm == 1) {
					...
					double[] s2 = climbing.execute(1);
					plotarGrafico(s2, "Sphere Function with Hill Climbing");
					
					HillClimbing climbing3 = new HillClimbing(100, 0.01, -100, 100,10, 100000);
					double[] s3 = climbing.execute(1);
					plotarGrafico(s3, "Sphere Function with Hill Climbing");
				}else if(algorithm == 2) {
					...
					BuscaTabu tabu = new BuscaTabu(100,0.01,-100,100,3,3,10000,10);
